...
function EditDeal({setClicked, table_id, row_id}){
    ...
    useEffect(() => {
        axios.get(`/deals/${table_id}`).then((res) => {
            ...
            setDeal_id(deal.id);
            setMarket(deal.market);
            setSetup(deal.setup);
            setLong_or_short(deal.long_or_short);
            setResult(deal.result);
            setSession(deal.session);
            setPlan_impuls(deal.plan_impuls);
            setProfit(deal.profit);
            setShort_description(deal.short_description);
            setNotes(deal.notes);
            setEmotion_before(deal.emotion_before);
            setEmotion_during(deal.emotion_during);
            setPower_of_emotion(deal.power_of_emotion);
            setMistake(deal.mistake);
            setIdeas(deal.ideas);
            setRight_actions(deal.right_actions);
            setLink(deal.link);
